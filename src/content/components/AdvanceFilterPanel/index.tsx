				...
				<div style={styles.cardContent}>
					...
					>
						<button
							...
							disabled={!getLoginState().isLoggedIn}
							title={!getLoginState().isLoggedIn ? "Please login to use recommendation" : "Get personalized recommendations"}
							style={{
								...styles.btn,
								...styles.btnLg,
								...styles.btnGradient,
								...
								...(!getLoginState().isLoggedIn && { opacity: 0.5, cursor: "not-allowed", background: "#9ca3af" }),
							}}
