...
import { ShadcnMultiSelect } from "./components/ShadcnMultiSelect";
				...
				<div style={styles.cardContent}>
					<div style={getQuickFiltersGridStyle()}>
						...
						<div style={styles.spaceY2}>
							...
							<ShadcnMultiSelect
								options={availableContestTypes.map((type) => ({
									value: type,
									label: type,
								}))}
								selectedValues={selectedContestTypes}
								onChange={handleContestTypeToggle}
								placeholder="Select contest type"
								isOpen={activeDropdown === "contestType"}
								onToggle={() =>
									setActiveDropdown(
										activeDropdown === "contestType" ? null : "contestType",
									)
								}
						...
						<div style={styles.spaceY2}>
							...
							<ShadcnMultiSelect
								options={availableProblemIndices}
								selectedValues={selectedProblemIndices}
								onChange={handleProblemIndexToggle}
								placeholder="Select indices"
								isOpen={activeDropdown === "problemIndex"}
								onToggle={() =>
									setActiveDropdown(
										activeDropdown === "problemIndex" ? null : "problemIndex",
									)
								}
								onClose={() => setActiveDropdown(null)}
							/>
						...
						<div style={styles.spaceY2}>
							...
							<ShadcnMultiSelect
								options={availableSheetNames.map((name) => ({
									value: name,
									label: name,
								}))}
								selectedValues={selectedSheets}
								onChange={handleSheetToggle}
								placeholder="Select sheets"
								isOpen={activeDropdown === "sheets"}
								onToggle={() =>
									setActiveDropdown(
										activeDropdown === "sheets" ? null : "sheets",
									)
								}
								onClose={() => setActiveDropdown(null)}
							/>
